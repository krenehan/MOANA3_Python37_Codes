...
class TestingPaths:
    ...
    def __init__(self, chip_name, experimental_dir):
        ...
        self.bitfile_path = os.path.join(os.path.join(os.path.join(self.platform_dir, "fpga"), "bit_files"), \
            'MOANA2_v1p2_INTERNAL_CLOCKS_6MHz.bit') # Uncomment line for internal clock
            # 'MOANA2_v1p2_EXTERNAL_REFCLK_6MHz.bit') # Uncomment line for external laser clock
...
paths = TestingPaths(chip_name = "moana3_xem6010", experimental_dir = "../../../../")
