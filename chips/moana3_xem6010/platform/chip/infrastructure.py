...
class Infrastructure:
    ...
    def __init__(self, number_multicell_rows = 1, number_multicells_per_row = 1):
        ...
        self.chip_signal['vrst_adj_enable'] =           __signal__.SIGNAL_VRST_ADJ_ENABLE
        self.chip_signal['vdd_sm_enable'] =             __signal__.SIGNAL_VDD_SM_ENABLE
        self.chip_signal['vdd_ldo_enable'] =            __signal__.SIGNAL_VDD_LDO_ENABLE
        ...
        self.chip_signal['level_shifter_enable'] =      __signal__.SIGNAL_LEVEL_SHIFTER_ENABLE
