...
# Optional operations
if do_raw_histogram:
    roi_raw_histograms(bkg_key, roi_key, frame_window=frame_window, data_dir_prefix=data_dir_prefix)
if do_contrast:
    roi_contrast(bkg_key, roi_key, frame_window=frame_window, data_dir_prefix=data_dir_prefix)
if do_contrast_to_noise:
    roi_contrast_to_noise(bkg_key, roi_key, frame_window=frame_window, data_dir_prefix=data_dir_prefix)
if do_roi_difference_matrix:
    roi_difference_matrix(bkg_key, roi_key, frame_window=frame_window, data_dir_prefix=data_dir_prefix)
