...
for time_gate_value in time_gate_list:
    ...
    try:
        ...
        # Divider values (0 -> -2.4V, 127 -> 0.0V)
        div_val_1 = 0.8
        div_val_2 = 1.0
        ...
        while True:
            ...
            # Begin blitz
            # print("Val1: {} , Val2: {}".format(div_val_1,div_val_2))
            dut.update_vcsel_data_bits(div_val_1, div_val_2)
            dut.vcsel_enable_trigger()
            
            # Shift
            # div_val_1 = div_val_1 + 1
            # div_val_2 = div_val_2 + 1
