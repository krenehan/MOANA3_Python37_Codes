...
class TestingPaths:
    ...
    def __init__(self, chip_name, experimental_dir):
        ...
        self.bitfile_path = os.path.join(os.path.join(os.path.join(self.platform_dir, "fpga"), "bit_files"), \
            ...
            # 'MOANA3_RIGID4BY4_INTERNAL_CLOCKS_6MHz_GSG_Tx625.bit')
            'MOANA3_RIGID4BY4_INTERNAL_CLOCKS_6MHz_GSG_TX625_DP625.bit')
            # 'MOANA3_RIGID4BY4_INTERNAL_CLOCKS_6MHz_GSG.bit')            
