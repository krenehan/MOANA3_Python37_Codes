...
for w in ('nir', 'ir'):
    for vs in [1,2,3,4,5]:
        for sv in np.arange (0,11,1,dtype = int)/10:
            # =============================================================================
            ...
            conditions = "setting" + str(vcsel_setting) + "_" + \
            ...
            for time_gate_value in time_gate_list:
                ...
                if logging:
                    ...
                    results_dir = '../../data/blitz_irf_characterization/data_' + w + '/'
                ...
                try:
                    ...
                    if dynamic_mode:
                        ...
                        dynamic_packet.fill(field_dict={    'nir_vcsel_enable': nir_enabled, \
                                                            'ir_vcsel_enable': ir_enabled, \
