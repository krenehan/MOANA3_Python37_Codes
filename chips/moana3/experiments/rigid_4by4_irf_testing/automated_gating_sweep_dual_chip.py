...
# for vs in [0,1,2,3,4,5]:
    # for sv in np.arange (0,1,0.2):
for av in range(16):    
...
# =============================================================================
    ...
    for time_gate_value in time_gate_list:
        ...
        if logging:
            ...
            results_dir = '../../data/irf_improved_data_collection/data_reduced_hegiht/'
